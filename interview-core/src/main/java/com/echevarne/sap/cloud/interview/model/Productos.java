...
@MappedSuperclass
public abstract class Clientes implements Serializable, Cloneable, Comparable {
	...
	/**
	 * Basic wrapper for the {@link Clientes#onEquals(Object)} method that must
	...
	/**
	 * Basic wrapper for the {@link Clientes#onHashCode(int)} method that must be
	...
	protected Object clone() throws CloneNotSupportedException {
		try {
			Clientes cloneEntity = (Clientes) super.clone();
	...
	public int compareTo(Object o) {
		return this.getEntityCreationTimestamp().compareTo(((Clientes) o).getEntityCreationTimestamp());
	}
}
